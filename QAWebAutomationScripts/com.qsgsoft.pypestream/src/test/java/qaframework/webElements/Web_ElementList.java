...
public class Web_ElementList {
	 ...
	 * @throws Exception
	 */
	public Web_WebdriverWait element_wait(String elementName,
			String locatorStrategy) throws Exception {
		return new Web_WebdriverWait(this, this.getWebDriverBy(elementName,
				locatorStrategy));
	}

	public Web_WebElements dynamicElement(String elementName, String locator,
			String locatorStrategy) throws Exception {
		return new Web_WebElements(this, this.getWebDriverBy(elementName,
	...
	public By getWebDriverBy(String elementName, String locator,
			String locatorStrategy) throws Exception {
