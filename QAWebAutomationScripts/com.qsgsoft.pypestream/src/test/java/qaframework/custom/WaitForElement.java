...
public class WaitForElement {
	...
	public WebElement getElement(String elementId, String locatorStrategy)
		...
		/*
		 * switch (locatorStrategy) { case "xpath": element =
		 * wb_driver.findElement(By.xpath(elementId)); break; case "css":
		 * element = wb_driver.findElement(By.cssSelector(elementId)); break;
		 * case "id": element = wb_driver.findElement(By.id(elementId)); break;
		 * case "name": element = wb_driver.findElement(By.name(elementId));
		 * break; case "tagName": element =
		 * wb_driver.findElement(By.tagName(elementId)); break; case "linktext":
		 * element = wb_driver.findElement(By.linkText(elementId)); break; }
		 */
		return element;
	}
	...
	public void enterData(String elementID, String locator, String value)
			throws Exception {
		element = getElement(elementID, locator);
		element.clear();
	...
	public void waitForPageToLoad() throws Exception {
		...
		/*
		 * @SuppressWarnings("unused") boolean blnPageLoaded; do { blnPageLoaded
		 * = ((JavascriptExecutor) wb_driver).executeScript(
		 * "return document.readyState").equals("complete"); } while
		 * (blnPageLoaded = false);
		 */
	...
	public void waitForPageLoding() throws Exception {
		wb_driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
	...
	public void waitForElementBycssSelector(String strElement) throws Exception {
		int intCnt = 0;
		do {
			try {
	...
	public void waitForText(String strElementID, String strText)
		...
		do {
			try {
				assertTrue(wb_driver.findElement(By.xpath(strElementID))
	...
	public void waitForTextByCssSelector(String strElementID, String strText)
		...
		do {
			try {
				assertTrue(wb_driver.findElement(By.cssSelector(strElementID))
						.getText().contains(strText));
				break;
			} catch (AssertionError e) {
				intCnt++;
	...
	public void waitForGivenSeconds(int intSeconds) throws Exception {
		wb_driver.manage().timeouts()
				.implicitlyWait(intSeconds, TimeUnit.SECONDS);
	}
	...
	public void waitForTwoSecond() throws Exception {
		Thread.sleep(20000);
	}
}